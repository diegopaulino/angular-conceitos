...
export class FoodListService {
  ...
  private list: Array<string> = ['X Bacon', 'Feijão', 'Cebola'];
  ...
  // Retorna os dados sem da linha 8
  // public foodList() {
  //   return this.list;
  // }
  ...
  // public foodListaAlert(value: string) {
  //   return this.emitEvent.emit(value);
  //   ('');
  // }

  public foodListaAlert(value: FoodList) {
    return this.emitEvent.emit(value);
  }
}
